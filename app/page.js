    ...
    <div>
      <header className='flex justify-between pb-3 max-w-[270px] sm:max-w-[550px] m-auto pt-3 md:max-w-[700px] lg:max-w-[934px] xl:max-w-[1190px] sm:pb-4 2xl:max-w-[1446px] 2xl:pb-5'>
        ...
        <div className='flex gap-10 sm:gap-2 md:gap-5 lg:gap-6 xl:gap-8 2xl:gap-10 '>
          <div className=' font-Roboto hidden font-semibold text-gray-600 sm:flex sm:pt-3 sm:text-[10px] sm:gap-3 md:text-[12px] lg:text-[13px] lg:gap-4 xl:text-[16px] xl:gap-6 xl:font-bold 2xl:gap-8 2xl:text-[18px] 2xl:pt-4'>
            <p>About Us</p>
            <p>Careers</p>
            <p>Services</p>
            <p>Blog</p>
          ...
          <div>
            <p className='font-bold text-orange-400 bg-orange-50 p-3 pl-3 pr-3  rounded-full text-[9px] sm:pl-3 sm:pr-3 md:text-[12px] md:p-3 md:pl-4 md:pr-4 lg:text-[13px] lg:pr-5 lg:pl-5 xl:text-[16px] xl:pr-7 xl:pl-7 2xl:text-[22px] 2xl:pl-9 2xl:pr-9 2xl:p-4 2xl:rounded-full'>Clone Project</p>
          </div>
        </div>
      </header>
      <div className='bg-image bg-blue-100 pb-4 sm:pb-0'>
        <div className="flex flex-col-reverse pt-5 max-w-[270px] m-auto sm:flex-row sm:max-w-[550px] sm:pt-10 md:max-w-[700px] md:pt-16 lg:max-w-[934px] xl:max-w-[1190px] xl:pt-24 2xl:max-w-[1446px]">
          <div className='pt-4 sm:pt-2' >
            ...
            <div className="flex justify-center gap-2 pt-3 sm:justify-start sm:pt-2 sm:gap-2 md:pt-4 md:gap-4 lg:gap-5 lg:pt-6 xl:pt-8 xl:gap-8 2xl:gap-12 2xl:pt-11">
              <p className="text-[11px] text-white font-semibold bg-orange-400 p-3 pl-3 pr-3 sm:pl-7 sm:pr-7 rounded-[30px] sm:text-[10px] sm:p-3 md:text-[12px] md:p-4 lg:text-[13px] lg:pl-4 lg:pr-4 xl:text-[15px] xl:pr-7 xl:pl-7 2xl:text-[18px] 2xl:pl-9 2xl:pr-9 2xl:p-5 2xl:rounded-full">
                See Our Services
              </p>
              <p className="text-[11px] text-gray-800 font-semibold pt-[13px] sm:text-[12px] sm:pt-[11px] md:text-[13px] md:pt-[15px] lg:text-[14px] xl:text-[16px] xl:pt-[16px] 2xl:text-[18px] 2xl:pt-[21px]">
                See All Services
              </p>
            </div>
          ...
          <div>
            <img className="w-[400px] h-[190px] sm:w-[540px] sm:h-[260px] md:w-[700px] md:h-[340px] lg:w-[900px] lg:h-[400px] xl:w-[1300px] xl:h-[460px] 2xl:w-[1600px] 2xl:h-[570px]" src="images/men-img.png" />
          </div>
        </div>
      </div>
        ...
        <div className="max-w-[270px] m-auto pt-10  sm:max-w-[550px] sm:pt-14 md:max-w-[700px] md:pt-20   lg:max-w-[934px] lg:pt-24 xl:max-w-[1190px] 2xl:max-w-[1446px]">
          ...
          <div className="grid grid-cols-1 gap-7 pt-[25px] sm:grid-cols-2 sm:pt-[36px] lg:grid-cols-3 lg:gap-5 lg:pt-[42px] xl:gap-3 xl:pt-[60px] 2xl:grid-cols-3 2xl:gap-1 2xl:pt-[70px]">
            <div>
              ...
              <div className="flex">
                <p className="text-[16px] font-semibold pt-4 text-orange-400 2xl:text-[20px]">Learn More</p>
      ...
      <div className="pt-8 xl:pt-20">
        <div className="bg-blue-100 pt-10 pb-6 sm:pt-12  md:pt-14 lg:pt-20 lg:pb-10 xl:pt-24 xl:pb-20 2xl:pb-28 2xl:pt-32">
      ...
      <div className="pt-12 lg:max-w-[934px] lg:m-auto lg:pt-16 xl:max-w-[1190px] 2xl:max-w-[1446px]">
        <div className="bg-blue-100 pb-10 lg:rounded-xl">
          <div className="max-w-[270px] m-auto pt-12 sm:max-w-[550px] md:max-w-[700px] lg:max-w-[830px] lg:pt-10 xl:max-w-[1094px] xl:pt-14 2xl:max-w-[1350px]">
            <div className="hidden lg:block lg:flex lg:gap-8">
              <div className="bg-orange-50 lg:rounded-full lg:p-1 lg:pl-3 lg:pr-3 xl:p-2 xl:pl-5 xl:pr-5">
                <p className="text-orange-400 text-[12px] font-bold xl:text-[16px]">Business strategy</p>
              </div>
              <div className="">
                <p className=" text-[12px] font-bold text-gray-400 lg:border lg:border-gray-400 lg:rounded-full lg:p-1 lg:pl-3 lg:pr-3  xl:p-2 xl:pl-5 xl:pr-5 xl:text-[16px]">Digitalization</p>
              </div>
              <div className="">
                <p className=" text-[12px] font-bold text-gray-400 lg:border lg:border-gray-400 lg:rounded-full lg:p-1 lg:pl-3 lg:pr-3  xl:p-2 xl:pl-5 xl:pr-5 xl:text-[16px]">Risk assessment</p>
              </div>
            </div>
            <div className="md:flex md:flex-row-reverse lg:pt-12 xl:justify-between xl:pt-20">
              ...
              <div className="pt-5 md:pt-2 xl:pt-3 lg:m-0">
                ...
                <div className="flex gap-2 sm:justify-center sm:pt-4 md:justify-start md:pt-3 xl:pt-8 xl:gap-3 2xl:gap-4 2xl:pt-12">
                  <p className="text-[13px] font-semibold text-orange-400 leading-[17px] pt-3  md:text-[16px] xl:text-[18px] 2xl:text-[24px]">See all services</p>
      ...
      <div className="bg-orange-500 md:bg-transparent">
        <div className="pt-12 pb-10 md:grid md:grid-cols-2 md:pt-0 md:pb-0 lg:pt-16 xl:pt-16 2xl:pt-24">
          <div className="max-w-[270px] m-auto sm:max-w-[320px] md:m-0 md:max-w-full">
            <img className="w-full  h-[240px] md:h-[270px] lg:h-[288px] 2xl:h-[360px]" src="images/section6-img.png" />
          </div>
          <div>
            <div className="max-w-[270px] m-auto sm:max-w-[450px] sm:text-center md:bg-orange-500 md:m-0 md:text-start md:max-w-full">
              <div className="md:pl-10 xl:pl-20">
                <p className="text-white font-bold text-[24px] leading-[26px] pt-6 sm:text-[26px] sm:leading-[28px] md:max-w-[300px] md:font-semibold md:pt-16 lg:text-[30px] lg:max-w-[330px] lg:leading-[34px] 2xl:text-[44px] 2xl:max-w-[500px] 2xl:leading-[45px]">Energy of a start-up combined with 30 years of experience.</p>
                <div className="pt-4 sm:pt-6 md:pb-16 2xl:pt-8 2xl:pb-[81px]">
                  <div className="bg-white rounded-full p-2 pl-3 pr-3 max-w-[135px] sm:flex sm:justify-center sm:m-auto md:justify-start md:m-0 2xl:max-w-[190px] 2xl:p-3 2xl:pl-5 2xl:pr-5">
                    <p className="text-orange-400 text-[12px] font-semibold 2xl:text-[16px] 2xl:font-bold">See Job Vacancies</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="sm:flex sm:justify-center md:justify-start">
            <div className="flex pt-3 sm:pt-5 md:pt-6 xl:pt-10 2xl:pt-12">
              ...
              <div className="pt-[6px] pl-2 lg:pt-[10px] xl:pl-5 2xl:pt-[18px] 2xl:pl-6">
                <p className="font-bold text-[14px] xl:text-[18px] 2xl:text-[22px]">Chikelu Neo</p>
                <p className="text-orange-400 font-semibold text-[14px] xl:text-[18px] 2xl:text-[22px]">CEO at MazeAI</p>
              </div>
            </div >
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 gap-7 pt-[25px]  pb-10 xl:pb-16 2xl:pb-24 sm:grid-cols-2 sm:pt-[36px] lg:grid-cols-3 lg:gap-5 lg:pt-[42px] xl:gap-5 xl:pt-[60px] 2xl:grid-cols-3 2xl:gap-10 2xl:pt-[70px]">
              <div className="bg-white 2xl:max-w-[482px] rounded-3xl pb-4 2xl:pb-8">
                ...
                <div className="max-w-[230px] m-auto md:max-w-[280px]  xl:max-w-[340px] 2xl:max-w-[400px]">
                  ...
                  <div className="flex">
                    <p className="text-[12px] font-semibold pt-4 text-orange-400 xl:text-[16px] 2xl:text-[20px]">Learn More</p>
