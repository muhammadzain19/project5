        ...
        <div className='bg-sky-950'>
            <div className='max-w-[270px] m-auto sm:max-w-[550px] md:max-w-[700px] lg:max-w-[934px] lg:grid lg:grid-cols-3 lg:pt-8 xl:max-w-[1190px] xl:pt-12 2xl:max-w-[1446px] 2xl:pt-16'>
                <div className='pt-8 sm:pt-12 lg:pt-0'>
                    ...
                    <div className='flex gap-8 pt-14 sm:gap-28 justify-center md:gap-32 md:pt-20 lg:justify-start lg:gap-10 lg:pt-0 xl:gap-20 2xl:gap-28 xl:pl-8'>
                        <div className='text-white'>
                            <div>
                                <p className='text-[20px] font-bold sm:text-[26px] lg:text-[18px] 2xl:text-[22px]'>Company</p>
                            </div>
                            <div className='pt-4 leading-8 sm:text-[20px] sm:leading-10 lg:text-[14px] lg:pt-2 lg:leading-9 2xl:text-[18px] 2xl:pt-4 2xl:leading-10'>
                                <p>About Us</p>
                                <p>Careers</p>
                                <p>Services</p>
                                <p>Blog</p>
                        ...
                        <div className='text-white'>
                            ...
                            <div className='pt-4 leading-8 sm:text-[20px] sm:leading-10 lg:text-[14px] lg:pt-2 2xl:text-[18px] 2xl:pt-4 2xl:leading-10'>
                                <p>hi@finsweet.com</p>
                                <p className=''>+(123) 456-7890</p>
                            </div>
                        </div>
                    </div>
                    <div className='pt-12 sm:pt-16 lg:pt-0 xl:pl-12'>
                        <div>
                            <p className='text-[20px] font-bold text-white lg:text-[18px] 2xl:text-[22px]'>Join Newsletter</p>
                        </div>
                        <div className='pt-6'>
                            <div className='bg-white p-3 rounded-full pl-8 2xl:p-4 2xl:pl-10'>
                                <p className='font-semibold text-gray-500 2xl:text-[18px]'>Type email here</p>
                            </div>
                        </div>
                        <div className='pt-2 sm:pt-4'>
                            <div className='bg-orange-400 p-3 rounded-full pl-8 max-w-[140px] sm:pl-12 sm:max-w-[170px] sm:m-auto lg:m-0 xl:pl-7 xl:max-w-[140px] 2xl:p-4 2xl:max-w-[170px] 2xl:pl-10'>
                                <p className='text-white font-semibold 2xl:text-[18px]'>Subscribe</p>
                            </div>
                        </div>
                    </div>
            </div>
            <div className='text-white max-w-[270px] sm:max-w-[550px] m-auto pt-10 pb-8 md:pt-14 lg:max-w-[934px] lg:flex lg:justify-between xl:max-w-[1190px] xl:pt-20 2xl:max-w-[1446px] 2xl:pt-24 2xl:pb-14'>
                ...
                <div className='flex gap-5 pt-2 text-[12px] justify-center sm:text-[14px] md:text-[16px] lg:justify-start lg:pt-0 lg:text-[16px] xl:gap-10 2xl:text-[16px]'>
                    <p>Privacy Policy</p>
